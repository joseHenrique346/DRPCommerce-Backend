...
public class DropTransaction : BaseEntity
{
    ...
    public void Update(long dropOrderId, long customerId, long dropTransactionTypeId, long dropTransactionMethodId, long dropTransactionStatusId, decimal amount, decimal fee, string gatewayReference, string gatewayProvider, string gatewayPayload, DateTime? paidAt, DateTime? refundedAt)
    {
        BaseValidate.ValidateId(dropOrderId, nameof(dropOrderId));
        BaseValidate.ValidateId(customerId, nameof(customerId));
        BaseValidate.ValidateId(dropTransactionTypeId, nameof(dropTransactionTypeId));
